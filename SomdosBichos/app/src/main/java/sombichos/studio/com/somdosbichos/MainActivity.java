    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.cachorroId:
                player = MediaPlayer.create(MainActivity.this, R.raw.cao);
                tocarSom();
                break;
            case R.id.gatoId:
                player = MediaPlayer.create(MainActivity.this,R.raw.gato);
                tocarSom();
                break;
            case R.id.leaoId:
                player = MediaPlayer.create(MainActivity.this,R.raw.leao);
                tocarSom();
                break;
            case R.id.macacoId:
                player = MediaPlayer.create(MainActivity.this,R.raw.macaco);
                tocarSom();
                break;
            case R.id.ovelhaId:
                player = MediaPlayer.create(MainActivity.this,R.raw.ovelha);
                tocarSom();
                break;
            case R.id.vacaId:
                player = MediaPlayer.create(MainActivity.this,R.raw.vaca);
                tocarSom();
                break;
        }
    }
